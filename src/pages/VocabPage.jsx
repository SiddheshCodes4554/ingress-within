        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
            <div className="bg-white border border-[#1E2A2E]/10 rounded-xl p-4 shadow-xs">
              <div className="text-[20px] font-bold font-mono">47</div>
              <div className="text-[11px] text-[#4A6A64] mt-0.5">entries tracked</div>
              <div className="text-[9.5px] text-[#8DBFB4] mt-0.5">across 2 cycles</div>
            </div>
            <div className="bg-white border border-[#1E2A2E]/10 rounded-xl p-4 shadow-xs">
              <div className="text-[20px] font-bold font-mono">38</div>
            ...
            <div className="bg-white border border-[#1E2A2E]/10 rounded-xl p-4 shadow-xs">
              <div className="text-[19px] font-bold text-[#8A3020] font-serif font-normal">"fine"</div>
              <div className="text-[11px] text-[#4A6A64] mt-0.5">most reached-for word</div>
              <div className="text-[9.5px] text-[#8DBFB4] mt-0.5">18× across both cycles</div>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#1E2A2E]/10 rounded-xl p-4.5 shadow-xs space-y-4">
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-2.5">
                <div className="flex items-center gap-3">
                  <span className="text-[12.5px] font-semibold w-24 shrink-0">fine</span>
                ...
                <div className="flex items-center gap-3">
                  <span className="text-[12.5px] font-semibold w-24 shrink-0">tired</span>
                  <div className="flex-1 h-[5px] bg-primary/5 rounded-full overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-[12.5px] font-semibold w-24 shrink-0">frustrated</span>
                  <div className="flex-1 h-[5px] bg-primary/5 rounded-full overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-[12.5px] font-semibold w-24 shrink-0">heavy</span>
                  <div className="flex-1 h-[5px] bg-primary/5 rounded-full overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-[12.5px] font-semibold w-24 shrink-0">conflicted</span>
                  <div className="flex-1 h-[5px] bg-primary/5 rounded-full overflow-hidden">
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-2.5">
                <div className="bg-[#F5F8F8] p-3 rounded-lg space-y-1.5">
                  <div className="flex flex-wrap items-center gap-1.5 text-xs">
                    <span className="px-2 py-0.5 rounded-full bg-[#E0A898]/15 text-[#8a3020] font-semibold border border-[#E0A898]/30">tired</span>
                    <span className="font-semibold font-mono text-[#8a3020]">×14</span>
                    <span className="text-mid">→</span>
                    <div className="flex gap-1 flex-wrap">
                      <span className="bg-[#1E2A2E]/5 px-1.5 py-0.5 rounded text-[11px] text-mid border border-[#1E2A2E]/10">exhausted</span>
                      <span className="bg-[#1E2A2E]/5 px-1.5 py-0.5 rounded text-[11px] text-mid border border-[#1E2A2E]/10">depleted</span>
                      <span className="bg-[#1E2A2E]/5 px-1.5 py-0.5 rounded text-[11px] text-mid border border-[#1E2A2E]/10">drained</span>
                    </div>
                  </div>
                ...
                <div className="bg-[#F5F8F8] p-3 rounded-lg space-y-1.5">
                  <div className="flex flex-wrap items-center gap-1.5 text-xs">
                    <span className="px-2 py-0.5 rounded-full bg-[#E0A898]/15 text-[#8a3020] font-semibold border border-[#E0A898]/30">fine</span>
                    <span className="font-semibold font-mono text-[#8a3020]">×18</span>
                    <span className="text-mid">→</span>
                    <div className="flex gap-1 flex-wrap">
                      <span className="bg-[#1E2A2E]/5 px-1.5 py-0.5 rounded text-[11px] text-mid border border-[#1E2A2E]/10">managing</span>
                      <span className="bg-[#1E2A2E]/5 px-1.5 py-0.5 rounded text-[11px] text-mid border border-[#1E2A2E]/10">numb</span>
                      <span className="bg-[#1E2A2E]/5 px-1.5 py-0.5 rounded text-[11px] text-mid border border-[#1E2A2E]/10">resigned</span>
                    </div>
                  </div>
                  <div className="text-[11.5px] text-[#4A6A64] italic leading-relaxed border-l-2 border-[#E0A898] pl-2.5">
                ...
                <div className="bg-[#F5F8F8] p-3 rounded-lg space-y-1.5">
                  <div className="flex flex-wrap items-center gap-1.5 text-xs">
                    <span className="px-2 py-0.5 rounded-full bg-[#E0A898]/15 text-[#8a3020] font-semibold border border-[#E0A898]/30">frustrated</span>
                    <span className="font-semibold font-mono text-[#8a3020]">×10</span>
                    <span className="text-mid">→</span>
                    <div className="flex gap-1 flex-wrap">
                      <span className="bg-[#1E2A2E]/5 px-1.5 py-0.5 rounded text-[11px] text-mid border border-[#1E2A2E]/10">resentful</span>
                      <span className="bg-[#1E2A2E]/5 px-1.5 py-0.5 rounded text-[11px] text-mid border border-[#1E2A2E]/10">bitter</span>
                      <span className="bg-[#1E2A2E]/5 px-1.5 py-0.5 rounded text-[11px] text-mid border border-[#1E2A2E]/10">blocked</span>
                    </div>
                  </div>
                  <div className="text-[11.5px] text-[#4A6A64] italic leading-relaxed border-l-2 border-[#E0A898] pl-2.5">
          ...
          <div className="bg-white border border-[#1E2A2E]/10 rounded-xl overflow-hidden shadow-xs">
            ...
            >
              <div className="flex items-center gap-3">
                <span className="px-2 py-0.5 rounded text-[9px] font-semibold bg-[#e0a898]/12 text-[#8a3020]">
                  Current
                </span>
                <span className="text-[13px] font-bold">Cycle 2</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-[11px] text-[#8DBFB4]">4 Jun – present · 19 entries</span>
                <ChevronDown size={14} className={`text-mid transition-transform ${vc2Open ? 'rotate-180' : ''}`} />
              </div>
            </div>
          ...
          <div className="bg-white border border-[#1E2A2E]/10 rounded-xl overflow-hidden shadow-xs">
            ...
            >
              <div className="flex items-center gap-3">
                <span className="px-2 py-0.5 rounded text-[9px] font-semibold bg-[#8DBFB4]/12 text-[#1A5040]">
                  Completed
                </span>
                <span className="text-[13px] font-bold">Cycle 1</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-[11px] text-[#8DBFB4]">7 May – 3 Jun · 28 entries</span>
                <ChevronDown size={14} className={`text-mid transition-transform ${vc1Open ? 'rotate-180' : ''}`} />
              </div>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between pb-1 border-b border-[#1E2A2E]/5">
              ...
              <span className="px-2 py-0.5 rounded-full text-[9px] bg-[#1E2A2E]/5 text-mid font-semibold">2 responses</span>
            </div>
